...
class ClientTCP extends Frame implements ActionListener, WindowListener {
    ...
    private void GUI() {
        ...
        tf2.setBounds(150, 135, 50, 25);
        tf3.setBounds(210, 135, 50, 25);
        ta.setBounds(150, 220, 150, 50);
        btn.setBounds(30, 40, 90, 40);
        btn1.setBounds(35, 133, 70, 30);
        la.setBounds(130, 50, 150, 25);
        la1.setBounds(280, 50, 150, 25);
        la2.setBounds(150, 100, 150, 25);
        la3.setBounds(160, 180, 150, 25);
