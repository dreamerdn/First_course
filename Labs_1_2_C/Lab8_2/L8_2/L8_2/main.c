...
int main()
{
    ...
    "1) Создать граф\n"
    "2) Удалить рёбра с номером 2\n"
    "3) Удалить вершину с номером 7\n"
